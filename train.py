...
class Trainer(object):
    def __init__(self):
        ...
        remark = "finetuing previous pretrained model, trained on old data"
        self.fold = 0
        self.total_folds = 7
        self.class_weights = [1, 1.5, 1, 1.5, 1.5]
        ...
        self.pretrained_path = "weights/20-7_efficientnet-b3_fold0_bgcco300/ckpt12.pth"
